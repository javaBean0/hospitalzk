...
public class HxjTemplate {
    ...
    public String getHxjTemplateid() {
        return hxjTemplateid;
    }

    public void setHxjTemplateid(String hxjTemplateid) {
        this.hxjTemplateid = hxjTemplateid == null ? null : hxjTemplateid.trim();
    }
    ...
    public String getCqzWc() {
        return cqzWc;
    }

    public void setCqzWc(String cqzWc) {
        this.cqzWc = cqzWc == null ? null : cqzWc.trim();
    }
