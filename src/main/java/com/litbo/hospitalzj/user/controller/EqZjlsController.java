...
public class EqZjlsController extends BaseController {
    ...
    @RequestMapping("/selectEq/{eqDah}")
    public ResponseResult<List<EqZjls>> selectEq(@PathVariable(value = "eqDah") String eqDah) {
        List<EqZjls> data=eqZjlsService.selectEqByDah(eqDah);
