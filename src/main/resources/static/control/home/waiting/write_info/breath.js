...
// 潮气量
    ...
    $("#cqzc13").blur(function(){
        ...
        if($("#cqz1Swc").val() >=-0.15 && $("#cqz1Swc").val() <= 0.15){
            $("#wc1").text("符合");
    ...
    $("#cqzc23").blur(function(){
        ...
        if($("#cqz2Swc").val() >=-0.15 && $("#cqz2Swc").val() <= 0.15){
            $("#wc2").text("符合");
    ...
    $("#cqzc33").blur(function(){
        ...
        if($("#cqz3Swc").val() >=-0.15 && $("#cqz3Swc").val() <= 0.15){
            $("#wc3").text("符合");
...
// 强制通气频率
    ...
    $("#qztqc13").blur(function(){
        ...
        if($("#qztq1Swc").val() >=-0.1 && $("#qztq1Swc").val() <= 0.1){
            $("#wc4").text("符合");
    ...
    $("#qztqc23").blur(function(){
        ...
        if($("#qztq2Swc").val() >=-0.1 && $("#qztq2Swc").val() <= 0.1){
            $("#wc5").text("符合");
    ...
    $("#qztqc33").blur(function(){
        ...
        if($("#qztq3Swc").val() >=-0.1 && $("#qztq3Swc").val() <= 0.1){
            $("#wc6").text("符合");
...
// 吸入氧浓度
    ...
    $("#xryc13").blur(function(){
        ...
        if($("#xry1Swc").val() >=-0.05 && $("#xry1Swc").val() <= 0.05){
            $("#wc7").text("符合");
    ...
    $("#xryc23").blur(function(){
        ...
        if($("#xry2Swc").val() >=-0.05 && $("#xry2Swc").val() <= 0.05){
            $("#wc8").text("符合");
    ...
    $("#xryc33").blur(function(){
        ...
        if($("#xry3Swc").val() >=-0.05 && $("#xry3Swc").val() <= 0.05){
            $("#wc9").text("符合");
...
// 吸气峰值压力
    ...
    $("#xqfc13").blur(function(){
        ...
        if($("#xqf1Swc").val() >= -3 && $("#xqf1Swc").val() <= 3){
            $("#wc10").text("符合");
    ...
    $("#xqfc23").blur(function(){
        ...
        if($("#xqf2Swc").val() >= -3 && $("#xqf2Swc").val() <= 3){
            $("#wc11").text("符合");
    ...
    $("#xqfc33").blur(function(){
        ...
        if($("#xqf3Swc").val() >= -3 && $("#xqf3Swc").val() <= 3){
            $("#wc12").text("符合");
...
// 呼气末正压
    ...
    $("#hqmc13").blur(function(){
        ...
        if($("#hqm1Swc").val() >= -2 && $("#hqm1Swc").val() <= 2){
            $("#wc13").text("符合");
    ...
    $("#hqmc23").blur(function(){
        ...
        if($("#hqm2Swc").val() >= -2 && $("#hqm2Swc").val() <= 2){
            $("#wc14").text("符合");
    ...
    $("#hqmc33").blur(function(){
        ...
        if($("#hqm3Swc").val() >= -2 && $("#hqm3Swc").val() <= 2){
            $("#wc15").text("符合");
